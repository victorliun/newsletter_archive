...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'NewsletterArchiveWIP.cloudinary_image_id'
        db.alter_column(u'archive_newsletterarchivewip', 'cloudinary_image_id', self.gf('django.db.models.fields.CharField')(max_length=40, null=True))

        # Changing field 'NewsletterArchive.cloudinary_image_id'
        db.alter_column(u'archive_newsletterarchive', 'cloudinary_image_id', self.gf('django.db.models.fields.CharField')(max_length=40, null=True))

    def backwards(self, orm):

        # Changing field 'NewsletterArchiveWIP.cloudinary_image_id'
        db.alter_column(u'archive_newsletterarchivewip', 'cloudinary_image_id', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'NewsletterArchive.cloudinary_image_id'
        db.alter_column(u'archive_newsletterarchive', 'cloudinary_image_id', self.gf('django.db.models.fields.IntegerField')(null=True))
