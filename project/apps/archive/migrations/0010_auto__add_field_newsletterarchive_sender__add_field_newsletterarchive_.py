...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NewsletterArchive.sender'
        db.add_column(u'archive_newsletterarchive', 'sender',
                      self.gf('django.db.models.fields.EmailField')(default=1, max_length=75),
                      keep_default=False)

        # Adding field 'NewsletterArchive.header'
        db.add_column(u'archive_newsletterarchive', 'header',
                      self.gf('django.db.models.fields.TextField')(default=1),
                      keep_default=False)


        # Changing field 'CompanyDetail.domain_names'
        db.alter_column(u'archive_companydetail', 'domain_names', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'CompanyDetail.subdomain_names'
        db.alter_column(u'archive_companydetail', 'subdomain_names', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):
        # Deleting field 'NewsletterArchive.sender'
        db.delete_column(u'archive_newsletterarchive', 'sender')

        # Deleting field 'NewsletterArchive.header'
        db.delete_column(u'archive_newsletterarchive', 'header')


        # Changing field 'CompanyDetail.domain_names'
        db.alter_column(u'archive_companydetail', 'domain_names', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'CompanyDetail.subdomain_names'
        db.alter_column(u'archive_companydetail', 'subdomain_names', self.gf('django.db.models.fields.CharField')(max_length=100))
