...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'NewsletterArchiveWIP.tags'
        db.delete_column(u'archive_newsletterarchivewip', 'tags')


    def backwards(self, orm):
        # Adding field 'NewsletterArchiveWIP.tags'
        db.add_column(u'archive_newsletterarchivewip', 'tags',
