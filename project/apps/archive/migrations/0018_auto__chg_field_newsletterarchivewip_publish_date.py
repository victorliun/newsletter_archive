...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'NewsletterArchiveWIP.publish_date'
        db.alter_column(u'archive_newsletterarchivewip', 'publish_date', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):

        # Changing field 'NewsletterArchiveWIP.publish_date'
        db.alter_column(u'archive_newsletterarchivewip', 'publish_date', self.gf('django.db.models.fields.DateField')(auto_now_add=True))
