...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NewsletterArchiveWIP.newsletter_tags'
        db.add_column(u'archive_newsletterarchivewip', 'newsletter_tags',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NewsletterArchiveWIP.newsletter_tags'
        db.delete_column(u'archive_newsletterarchivewip', 'newsletter_tags')
