...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'NewsletterArchive.cloudinary_image_url'
        db.alter_column(u'archive_newsletterarchive', 'cloudinary_image_url', self.gf('django.db.models.fields.URLField')(default='', max_length=200))
        ...
        # Changing field 'NewsletterArchiveWIP.cloudinary_image_url'
        db.alter_column(u'archive_newsletterarchivewip', 'cloudinary_image_url', self.gf('django.db.models.fields.URLField')(default='', max_length=200))

        # Changing field 'CompanyDetail.unsubscribe_url'
        db.alter_column(u'archive_companydetail', 'unsubscribe_url', self.gf('django.db.models.fields.URLField')(default='', max_length=200))

        # Changing field 'CompanyDetail.subscribe_url'
        db.alter_column(u'archive_companydetail', 'subscribe_url', self.gf('django.db.models.fields.URLField')(default='', max_length=200))

        # Changing field 'CompanyDetail.unsubscribe_email'
        db.alter_column(u'archive_companydetail', 'unsubscribe_email', self.gf('django.db.models.fields.EmailField')(default='', max_length=75))

        # Changing field 'CompanyDetail.subdomain_names'
        db.alter_column(u'archive_companydetail', 'subdomain_names', self.gf('django.db.models.fields.CharField')(default='', max_length=100))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'NewsletterArchive.cloudinary_image_url'
        db.alter_column(u'archive_newsletterarchive', 'cloudinary_image_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))
        ...
        # Changing field 'NewsletterArchiveWIP.cloudinary_image_url'
        db.alter_column(u'archive_newsletterarchivewip', 'cloudinary_image_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

        # Changing field 'CompanyDetail.unsubscribe_url'
        db.alter_column(u'archive_companydetail', 'unsubscribe_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

        # Changing field 'CompanyDetail.subscribe_url'
        db.alter_column(u'archive_companydetail', 'subscribe_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

        # Changing field 'CompanyDetail.unsubscribe_email'
        db.alter_column(u'archive_companydetail', 'unsubscribe_email', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True))

        # Changing field 'CompanyDetail.subdomain_names'
        db.alter_column(u'archive_companydetail', 'subdomain_names', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
    ...
    models = {
        ...
        u'archive.newsletterarchive': {
            ...
            'clouninary_image_id': ('django.db.models.fields.IntegerField', [], {'blank': 'True'}),
