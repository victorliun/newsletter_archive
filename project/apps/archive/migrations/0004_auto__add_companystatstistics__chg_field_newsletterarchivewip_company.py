...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CompanyStatstistics'
        db.create_table(u'archive_companystatstistics', (
            ('company', self.gf('django.db.models.fields.related.OneToOneField')(related_name='companystatstistics', unique=True, primary_key=True, to=orm['archive.CompanyDetail'])),
            ('newsletter_archived', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('newsletter_views', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('last_update', self.gf('django.db.models.fields.DateField')(auto_now=True, auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'archive', ['CompanyStatstistics'])


        # Changing field 'NewsletterArchiveWIP.company'
        db.alter_column(u'archive_newsletterarchivewip', 'company_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['archive.CompanyDetail']))

    def backwards(self, orm):
        # Deleting model 'CompanyStatstistics'
        db.delete_table(u'archive_companystatstistics')


        # Changing field 'NewsletterArchiveWIP.company'
        db.alter_column(u'archive_newsletterarchivewip', 'company_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['archive.CompanyDetail']))
