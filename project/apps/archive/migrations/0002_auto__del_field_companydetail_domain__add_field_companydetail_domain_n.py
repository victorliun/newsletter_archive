...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CompanyDetail.domain'
        db.delete_column(u'archive_companydetail', 'domain')

        # Adding field 'CompanyDetail.domain_names'
        db.add_column(u'archive_companydetail', 'domain_names',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=100),
                      keep_default=False)

        # Adding field 'CompanyDetail.subdomain_names'
        db.add_column(u'archive_companydetail', 'subdomain_names',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'CompanyDetail.domain'
        db.add_column(u'archive_companydetail', 'domain',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=100),
                      keep_default=False)

        # Deleting field 'CompanyDetail.domain_names'
        db.delete_column(u'archive_companydetail', 'domain_names')

        # Deleting field 'CompanyDetail.subdomain_names'
        db.delete_column(u'archive_companydetail', 'subdomain_names')
    ...
    models = {
        u'archive.companydetail': {
            ...
            'subdomain_names': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True'}),
