...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'NewsletterTag.newsletter'
        db.alter_column(u'archive_newslettertag', 'newsletter_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['archive.NewsletterArchiveWIP'], null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'NewsletterTag.newsletter'
        db.alter_column(u'archive_newslettertag', 'newsletter_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['archive.NewsletterArchiveWIP']))
