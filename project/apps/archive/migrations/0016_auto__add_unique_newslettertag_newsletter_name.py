...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'NewsletterTag', fields ['newsletter', 'name']
        db.create_unique(u'archive_newslettertag', ['newsletter_id', 'name'])


    def backwards(self, orm):
        # Removing unique constraint on 'NewsletterTag', fields ['newsletter', 'name']
        db.delete_unique(u'archive_newslettertag', ['newsletter_id', 'name'])
