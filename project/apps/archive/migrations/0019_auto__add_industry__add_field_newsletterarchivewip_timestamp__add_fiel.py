...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'archive_industry', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'archive', ['Industry'])

        # Adding field 'NewsletterArchiveWIP.timestamp'
        db.add_column(u'archive_newsletterarchivewip', 'timestamp',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 5, 3, 0, 0)),
                      keep_default=False)

        # Adding field 'CompanyDetail.industry'
        db.add_column(u'archive_companydetail', 'industry',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['archive.Industry'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Industry'
        db.delete_table(u'archive_industry')

        # Deleting field 'NewsletterArchiveWIP.timestamp'
        db.delete_column(u'archive_newsletterarchivewip', 'timestamp')

        # Deleting field 'CompanyDetail.industry'
        db.delete_column(u'archive_companydetail', 'industry_id')
    ...
    models = {
        u'archive.companydetail': {
            ...
            'industry': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['archive.Industry']", 'null': 'True', 'blank': 'True'}),
        ...
        u'archive.newsletterarchive': {
            ...
            'cloudinary_image_id': ('django.db.models.fields.CharField', [], {'max_length': '40', 'null': 'True', 'blank': 'True'}),
        ...
        u'archive.newsletterarchivewip': {
            ...
            'saved_mongo': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'sender': ('django.db.models.fields.EmailField', [], {'max_length': '75'}),
            'status': ('django.db.models.fields.CharField', [], {'default': "'1'", 'max_length': "'1'"}),
            'subject': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'timestamp': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 5, 3, 0, 0)'}),
            'url': ('django.db.models.fields.URLField', [], {'max_length': '200'})
        },
        u'archive.newslettertag': {
            'Meta': {'unique_together': "(('name', 'newsletter'),)", 'object_name': 'NewsletterTag'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '40'}),
            'newsletter': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['archive.NewsletterArchiveWIP']", 'null': 'True'}),
            'newsletter_date': ('django.db.models.fields.DateField', [], {})
        },
        u'auth.group': {
