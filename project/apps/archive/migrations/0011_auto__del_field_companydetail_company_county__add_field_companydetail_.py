...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CompanyDetail.company_county'
        db.delete_column(u'archive_companydetail', 'company_county')

        # Adding field 'CompanyDetail.company_country'
        db.add_column(u'archive_companydetail', 'company_country',
                      self.gf('django_countries.fields.CountryField')(default=1, max_length=2),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'CompanyDetail.company_county'
        db.add_column(u'archive_companydetail', 'company_county',
                      self.gf('django_countries.fields.CountryField')(default=1, max_length=2),
                      keep_default=False)

        # Deleting field 'CompanyDetail.company_country'
        db.delete_column(u'archive_companydetail', 'company_country')
