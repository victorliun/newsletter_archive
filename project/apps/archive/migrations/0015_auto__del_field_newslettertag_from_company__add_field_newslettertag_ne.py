...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'NewsletterTag', fields ['name']
        db.delete_unique(u'archive_newslettertag', ['name'])

        # Deleting field 'NewsletterTag.from_company'
        db.delete_column(u'archive_newslettertag', 'from_company_id')

        # Adding field 'NewsletterTag.newsletter_date'
        db.add_column(u'archive_newslettertag', 'newsletter_date',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 4, 13, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'NewsletterTag.from_company'
        db.add_column(u'archive_newslettertag', 'from_company',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['archive.CompanyDetail'], null=True),
                      keep_default=False)

        # Deleting field 'NewsletterTag.newsletter_date'
        db.delete_column(u'archive_newslettertag', 'newsletter_date')

        # Adding unique constraint on 'NewsletterTag', fields ['name']
        db.create_unique(u'archive_newslettertag', ['name'])
