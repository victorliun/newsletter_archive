...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NewsletterArchiveWIP.saved_mongo'
        db.add_column(u'archive_newsletterarchivewip', 'saved_mongo',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NewsletterArchiveWIP.saved_mongo'
        db.delete_column(u'archive_newsletterarchivewip', 'saved_mongo')
