...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'NewsletterArchiveWIP.clouninary_image_id'
        db.delete_column(u'archive_newsletterarchivewip', 'clouninary_image_id')

        # Adding field 'NewsletterArchiveWIP.cloudinary_image_id'
        db.add_column(u'archive_newsletterarchivewip', 'cloudinary_image_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'NewsletterArchive.clouninary_image_id'
        db.delete_column(u'archive_newsletterarchive', 'clouninary_image_id')

        # Adding field 'NewsletterArchive.cloudinary_image_id'
        db.add_column(u'archive_newsletterarchive', 'cloudinary_image_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'NewsletterArchiveWIP.clouninary_image_id'
        db.add_column(u'archive_newsletterarchivewip', 'clouninary_image_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'NewsletterArchiveWIP.cloudinary_image_id'
        db.delete_column(u'archive_newsletterarchivewip', 'cloudinary_image_id')

        # Adding field 'NewsletterArchive.clouninary_image_id'
        db.add_column(u'archive_newsletterarchive', 'clouninary_image_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'NewsletterArchive.cloudinary_image_id'
        db.delete_column(u'archive_newsletterarchive', 'cloudinary_image_id')
    ...
    models = {
        u'archive.companydetail': {
            ...
            'domain_names': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'subdomain_names': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
        ...
        u'archive.newsletterarchive': {
            ...
            'cloudinary_image_id': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
        ...
        u'archive.newslettertag': {
            ...
            'from_company': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['archive.CompanyDetail']", 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '40'}),
            'newsletter': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['archive.NewsletterArchiveWIP']", 'null': 'True'})
        },
        u'auth.group': {
